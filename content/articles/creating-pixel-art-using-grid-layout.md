...
It's a dull job. To avoid that later, I’ve created a [pixel art editor](http://jackiecardozo.com/pixgrid/) which generates sprites into HTML & CSS. You can actually animate sprites using CSS animation. I'll get into the details of that in this article.
